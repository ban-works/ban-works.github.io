    ...
    <div>
      <Container style={{ display: "flex", justifyContent: "center" }}>
        ...
        <span style={{ fontSize: "20px", paddingRight: "10px" }}>📄</span>
          <a target='_blank' href='https://drive.google.com/file/d/1_Cv-iu1aR_fZLhFBxdImgUdozG5toqp3/view?usp=sharing'>Consultez mon CV</a>
          </div>
                </Col>
                <Col md="4">
                  <img
        ...
        <span style={{ fontSize: "40px",}}>✌️ </span>
          <Link style={{ fontSize: "20px", color: 'black' }} to="/post/intro">Cheat Sheet - Set Up Commands for Git, Express, React & React Native</Link>    
          </div>
          </Col>
          <Row style={{ marginTop: "30px" }}>
            ...
            <Col xs="12" md="6" className="p-2">
              ...
              <img
                ...
                <CardBody style={{paddingLeft: '12px', paddingRight: '12px'}}>
            ...
            <Col xs="12" md="6" className="p-2">
              ...
              <img
                ...
                <CardBody style={{paddingLeft: '12px', paddingRight: '12px'}}>
                  ...
                  <CardText>
                    Deuxième projet React avec utilisation de <a target='_blank' href='https://newsapi.org/'>News API</a>
                  </CardText>
                  <Button
                    target="_blank"
            ...
            <Col xs="12" md="6" className="p-2">
              <Card>
                <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'center'}}> <img
                ...
                <CardBody style={{paddingLeft: '12px', paddingRight: '12px'}}>
                  ...
                  <CardText>
                    ...
                    Features : 
                    <br/>
                    - Géolocalisation de plusieurs users
                    - Chat en direct via websocket.io
                    - Ajout de POI et du username en stockage local 
                  </CardText>
                  <Button
                    target="_blank"
